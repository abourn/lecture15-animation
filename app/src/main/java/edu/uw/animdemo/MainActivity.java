    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.menu_pulse:
                ...
                // will look for setter that corresponds to the radius property within the ball class...
...
//                animator.setRepeatMode(ObjectAnimator.REVERSE); // start from a --> b then go b --> a
//                animator.start();
